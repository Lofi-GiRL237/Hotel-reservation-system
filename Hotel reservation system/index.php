    ...
    <div class="welcome-message">
        <div class="wrap-info">
            <div class="information">
                <h1  class="animated fadeInDown">Welcome To <b>Sky Hotel</b></h1>
                <p class="animated fadeInUp">Most luxurious hotel of littoral with the royal treatments and excellent customer service.</p>                
            </div>
